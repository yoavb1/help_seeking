"""
Django settings for HelpSeeking project.
...
# Load the .env file located in your project root
load_dotenv(dotenv_path=BASE_DIR / '.env')

# Grab the secret code
...
WSGI_APPLICATION = 'HelpSeeking.wsgi.application'
